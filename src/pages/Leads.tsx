...
import { Plus, Edit, Trash2, Copy, Search, Download, ExternalLink, Users } from 'lucide-react';
        ...
        <div className="bg-gradient-to-r from-primary to-secondary rounded-lg p-6 text-primary-foreground">
          <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold">Gerenciamento de Leads</h1>
